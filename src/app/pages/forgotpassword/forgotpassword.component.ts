...
@Component({
  ...
  imports: [StepperModule, ButtonModule , InputOtp , ReactiveFormsModule , FormsModule , RouterLink],
 ...
 //   Form (2)  generate object => code 
  ...
  verifyResetCode(activateCallback:any) {
    ...
    if(this.verifyCode.valid) {
      this.authService.virfiyResetCode(this.verifyCode.value).subscribe({
        next:(res)=>{
